...
var EventoService = (function () {
    ...
    EventoService.prototype.addEvento = function (nombre_evento, nombre_municipalidad) {
        ...
        return this.http.post("http://localhost:58326/api/eventos/addEvento?" + postInfo, {}, options).map(function (data) { return data.json(); });
    };
    EventoService.prototype.addUmbral = function (nombre_evento, nombre_municipalidad, IdFuenteDeDato, valor) {
        ...
        return this.http.post("http://localhost:58326/api/eventos/addUmbral?" + postInfo, {}, options).map(function (data) { return data.json(); });
    };
