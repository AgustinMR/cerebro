...
var EventoComponent = (function () {
    ...
    EventoComponent.prototype.addEvento = function () {
        var _this = this;
        this.eventos.addEvento("vientos fuertes", this.nombre_municipalidad).subscribe(function (data) { return _this.eventoAgregado = data; }, function (responseError) { return console.log(responseError); }, function () {
            console.log(_this.eventoAgregado);
            _this.eventos.addUmbral("vientos fuertes", _this.nombre_municipalidad, "59174a23277b658f30a00bc5", "120").subscribe(function (data) { return _this.umbralAgregado = data; }, function (responseError) { return console.log(responseError); }, function () { return console.log("ok " + _this.umbralAgregado); });
        });
    };
