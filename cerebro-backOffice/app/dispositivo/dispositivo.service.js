...
var FuenteDeDatoService = (function () {
    ...
    FuenteDeDatoService.prototype.agregarFuente = function (dirIp, userAgent, tipo, ubicacion, municipalidad, nombre) {
    ...
    FuenteDeDatoService.prototype.modificarFuente = function (dirIp, userAgent, ubicacion, id) {
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var options = new http_1.RequestOptions({ headers: headers });
