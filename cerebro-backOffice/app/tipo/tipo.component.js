...
var TipoDeFuenteDeDatoComponent = (function () {
    ...
    TipoDeFuenteDeDatoComponent.prototype.agregarTipoDeFuenteDeDato = function () {
        ...
        this.tipos.agregarTipo(this.nombre, this.tipoDeDato, this.endpointWS, this.frecLectura, this.nombre_municipalidad).subscribe(function (data) { _this.repuesta = data; _this.mostrarMensajeExito(); }, function (responseError) { console.log("Error: " + responseError); _this.mostrarMensajeError(); }, function () {
            _this.nombre = "";
            _this.tipoDeDato = "";
            _this.endpointWS = "";
            _this.frecLectura = "";
            _this.getTipos();
            console.log(_this.repuesta);
        });
    };
    TipoDeFuenteDeDatoComponent.prototype.modificarTipoDeFuenteDeDato = function () {
        var _this = this;
        if (this.selectTipoMod != "") {
            this.tipos.modificarTipo(this.nombreMod, this.endpointWSMod, this.frecLecturaMod, this.selectTipoMod).subscribe(function (data) { _this.repuesta = data; _this.mostrarMensajeTipoModificado(); }, function (responseError) { console.log("Error: " + responseError); _this.mostrarMensajeError(); }, function () {
                _this.nombreMod = "";
                _this.tipoDeDatoMod = "";
                _this.endpointWSMod = "";
                _this.frecLecturaMod = "";
                _this.selectTipoMod = "";
                _this.getTipos();
                console.log(_this.repuesta);
            });
