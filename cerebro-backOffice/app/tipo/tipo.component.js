...
var TipoDeFuenteDeDatoComponent = (function () {
    ...
    TipoDeFuenteDeDatoComponent.prototype.deleteTipo = function () {
        ...
        if (this.tipoSeleccionado !== "") {
            this.mostrarMensajeLoading();
            this.tipos.deleteTipo(this.tipoSeleccionado).subscribe(function (data) { _this.mostrarMensajeTipoQuitado(); console.log(data); }, function (responseError) { console.log(responseError); _this.mostrarMensajeError(); }, function () { return console.log("Tipo de fuente de datos eliminado"); });
        }
    };
