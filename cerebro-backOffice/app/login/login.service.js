...
var LoginService = (function () {
    ...
    LoginService.prototype.loginAdmin = function (email, nombre_municipalidad, password) {
        ...
        return this.http.post("http://localhost:58326/api/usuarios/loginAdministrador?" + postInfo, {}, options).map(function (data) { return data.json(); });
    };
    LoginService.prototype.obtenerMunicipalidades = function () {
        return this.http.get("http://localhost:58326/api/municipalidades").map(function (data) { return data.json(); });
