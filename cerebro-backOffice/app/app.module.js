...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [app_component_1.AppComponent, dispositivo_component_1.FuenteDeDatoComponent, tipo_component_1.TipoDeFuenteDeDatoComponent, evento_component_1.EventoComponent, usuario_component_1.UsuarioComponent, estadistica_component_1.EstadisticaComponent],
        /*providers: [EmployeeService, HttpModule, EmployeeTaskService,
            { provide: SignalrWindow, useValue: window },
            { provide: 'channel.config', useValue: channelConfig }],*/
        providers: [dispositivo_service_1.FuenteDeDatoService, tipo_service_1.TipoDeFuenteDeDatoService, evento_service_1.EventoService, usuario_service_1.UsuarioService, estadistica_service_1.EstadisticaService, http_1.HttpModule],
